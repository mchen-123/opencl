...
#define CL_KHR_UNIFIED_SVM_EXTENSION_NAME "cl_khr_unified_svm"
...
#define CL_SVM_TYPE_MACRO_COARSE_GRAIN_BUFFER_KHR                                           \
  (CL_SVM_CAPABILITY_SINGLE_ADDRESS_SPACE_KHR | CL_SVM_CAPABILITY_DEVICE_UNASSOCIATED_KHR | \
   CL_SVM_CAPABILITY_CONTEXT_ACCESS_KHR | CL_SVM_CAPABILITY_HOST_MAP_KHR |                  \
   CL_SVM_CAPABILITY_DEVICE_READ_KHR | CL_SVM_CAPABILITY_DEVICE_WRITE_KHR |                 \
   CL_SVM_CAPABILITY_DEVICE_ATOMIC_ACCESS_KHR)
#define CL_SVM_TYPE_MACRO_FINE_GRAIN_BUFFER_KHR                                             \
  (CL_SVM_CAPABILITY_SINGLE_ADDRESS_SPACE_KHR | CL_SVM_CAPABILITY_DEVICE_UNASSOCIATED_KHR | \
   CL_SVM_CAPABILITY_CONTEXT_ACCESS_KHR | CL_SVM_CAPABILITY_HOST_READ_KHR |                 \
   CL_SVM_CAPABILITY_HOST_WRITE_KHR | CL_SVM_CAPABILITY_HOST_MAP_KHR |                      \
   CL_SVM_CAPABILITY_DEVICE_READ_KHR | CL_SVM_CAPABILITY_DEVICE_WRITE_KHR |                 \
   CL_SVM_CAPABILITY_DEVICE_ATOMIC_ACCESS_KHR | CL_SVM_CAPABILITY_CONCURRENT_ACCESS_KHR)
#define CL_SVM_TYPE_MACRO_DEVICE_KHR                                                 \
  (CL_SVM_CAPABILITY_SINGLE_ADDRESS_SPACE_KHR | CL_SVM_CAPABILITY_DEVICE_OWNED_KHR | \
   CL_SVM_CAPABILITY_DEVICE_READ_KHR | CL_SVM_CAPABILITY_DEVICE_WRITE_KHR |          \
   CL_SVM_CAPABILITY_DEVICE_ATOMIC_ACCESS_KHR | CL_SVM_CAPABILITY_INDIRECT_ACCESS_KHR)
#define CL_SVM_TYPE_MACRO_HOST_KHR                                                          \
  (CL_SVM_CAPABILITY_SINGLE_ADDRESS_SPACE_KHR | CL_SVM_CAPABILITY_DEVICE_UNASSOCIATED_KHR | \
   CL_SVM_CAPABILITY_CONTEXT_ACCESS_KHR | CL_SVM_CAPABILITY_HOST_OWNED_KHR |                \
...
#define CL_SVM_TYPE_MACRO_SINGLE_DEVICE_SHARED_KHR                                \
  (CL_SVM_CAPABILITY_SINGLE_ADDRESS_SPACE_KHR | CL_SVM_CAPABILITY_HOST_READ_KHR | \
   CL_SVM_CAPABILITY_HOST_WRITE_KHR | CL_SVM_CAPABILITY_DEVICE_READ_KHR |         \
   CL_SVM_CAPABILITY_DEVICE_WRITE_KHR | CL_SVM_CAPABILITY_INDIRECT_ACCESS_KHR)
#define CL_SVM_TYPE_MACRO_SYSTEM_KHR                                                          \
  (CL_SVM_CAPABILITY_SINGLE_ADDRESS_SPACE_KHR | CL_SVM_CAPABILITY_SYSTEM_ALLOCATED_KHR |      \
   ...
   CL_SVM_CAPABILITY_DEVICE_WRITE_KHR | CL_SVM_CAPABILITY_DEVICE_ATOMIC_ACCESS_KHR |          \
   CL_SVM_CAPABILITY_CONCURRENT_ACCESS_KHR | CL_SVM_CAPABILITY_CONCURRENT_ATOMIC_ACCESS_KHR | \
   CL_SVM_CAPABILITY_INDIRECT_ACCESS_KHR)


typedef void *CL_API_CALL
clSVMAllocWithPropertiesKHR_t(cl_context context, const cl_svm_alloc_properties_khr *properties,
                              cl_uint svm_type_index, size_t size, cl_int *errcode_ret);

typedef clSVMAllocWithPropertiesKHR_t *clSVMAllocWithPropertiesKHR_fn;

typedef cl_int CL_API_CALL
clSVMFreeWithPropertiesKHR_t(cl_context context, const cl_svm_free_properties_khr *properties,
                             cl_svm_free_flags_khr flags, void *ptr);

typedef clSVMFreeWithPropertiesKHR_t *clSVMFreeWithPropertiesKHR_fn;

typedef cl_int CL_API_CALL clGetSVMPointerInfoKHR_t(cl_context context, cl_device_id device,
                                                    const void *ptr,
                                                    cl_svm_pointer_info_khr param_name,
                                                    size_t param_value_size, void *param_value,
                                                    size_t *param_value_size_ret);

typedef clGetSVMPointerInfoKHR_t *clGetSVMPointerInfoKHR_fn;

typedef cl_int CL_API_CALL clGetSVMSuggestedTypeIndexKHR_t(
    cl_context context, cl_svm_capabilities_khr required_capabilities,
    cl_svm_capabilities_khr desired_capabilities, const cl_svm_alloc_properties_khr *properties,
    size_t size, cl_uint *suggested_svm_type_index);

typedef clGetSVMSuggestedTypeIndexKHR_t *clGetSVMSuggestedTypeIndexKHR_fn;

#if !defined(CL_NO_NON_ICD_DISPATCH_EXTENSION_PROTOTYPES)

extern CL_API_ENTRY void *CL_API_CALL
clSVMAllocWithPropertiesKHR(cl_context context, const cl_svm_alloc_properties_khr *properties,
                            cl_uint svm_type_index, size_t size, cl_int *errcode_ret);

extern CL_API_ENTRY cl_int CL_API_CALL
clSVMFreeWithPropertiesKHR(cl_context context, const cl_svm_free_properties_khr *properties,
                           cl_svm_free_flags_khr flags, void *ptr);

extern CL_API_ENTRY cl_int CL_API_CALL clGetSVMPointerInfoKHR(
    cl_context context, cl_device_id device, const void *ptr, cl_svm_pointer_info_khr param_name,
    size_t param_value_size, void *param_value, size_t *param_value_size_ret);

extern CL_API_ENTRY cl_int CL_API_CALL clGetSVMSuggestedTypeIndexKHR(
    cl_context context, cl_svm_capabilities_khr required_capabilities,
    cl_svm_capabilities_khr desired_capabilities, const cl_svm_alloc_properties_khr *properties,
    size_t size, cl_uint *suggested_svm_type_index);
...
#define CL_IMG_SAFETY_MECHANISMS_EXTENSION_NAME "cl_img_safety_mechanisms"
