...
void load_and_run_kernel() {
  ...
  cl_program program = clCreateProgramWithBinary(
      context, 1, &device, &binarySize, (const unsigned char **)&binaryData, &binaryStatus, &err);
  ...
  err =
      clEnqueueNDRangeKernel(queue, kernel, 1, nullptr, &global_work_size, nullptr, 0, NULL, NULL);
  if (err != CL_SUCCESS) {
